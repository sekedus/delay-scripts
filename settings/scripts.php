...
function delay_scripts_settings_scripts() {
...
<form method="POST">
    ...
    <tbody>
        <tr>
            ...
            <td>
                <textarea name="delay_scripts_include_list" rows="4" cols="50"><?php echo implode('&#10;', $include_list); ?></textarea>
            </td>
        </tr>
        <tr>
            <th scope="row"><label>Timeout</label></th>
            <td>
                <select name="delay_scripts_timeout" value="<?php echo $timeout; ?>">
